module xtb.core.fmt.print;

nothrow @nogc:

public import xtb.core.fmt.writer;

import core.stdc.stdio : FILE, fflush, fwrite, stderr, stdout;

import xtb.core.types : String, u8;

version (unittest) import xtb.core.fmt.fixed_buffer : formatBuffer, writeBuffer;

version (unittest) import xtb.core.fmt.format : format, formatln, formatString, tryFormatString;

version (unittest) import xtb.core.string : StringBuf;
