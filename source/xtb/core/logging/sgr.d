...
package enum SgrParseKind : ubyte
{
    unsupported,
    incomplete,
    complete,
...
package enum maxSupportedSgrLength = AnsiSequence.capacity;

package SgrParseResult parseSgrPrefix(scope String bytes)
pure @safe
{
...
package size_t safeSgrPrefixLength(scope String bytes)
pure @safe
{
    if (bytes.length == 0)
        return 0;
