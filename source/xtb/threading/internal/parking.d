module xtb.threading.internal.parking;
...
package(xtb.threading) enum ParkResult : ubyte
{
    valueMismatch,
    wokenOrSpurious,
}
...
package(xtb.threading) ParkResult park(uint* address, uint expected) @system
{
    version (XTB_TestUnsupportedThreadBackend)
    {
...
package(xtb.threading) void wakeOne(uint* address) @system
{
    version (XTB_TestUnsupportedThreadBackend)
    {
        panic("thread parking is unsupported on this platform");
...
package(xtb.threading) void wakeAll(uint* address) @system
{
    version (XTB_TestUnsupportedThreadBackend)
    {
        panic("thread parking is unsupported on this platform");
