module xtb.threading.internal.start_latch;
...
package(xtb.threading) enum bool startLatchSupported = Atomic!uint.waitSupported;
...
/// waiter, one lifetime.
package(xtb.threading) struct StartLatch
{
nothrow @nogc:
    @disable this(this);
