...
version (unittest) import xtb.lifetime : move;
version (unittest) import xtb.types : i32;
...
mixin template DataStruct() {
    static assert(typeof(this).tupleof.length != 0,
    ...
    mixin((() {
        ...
        static foreach (index; 0 .. T.tupleof.length) {{
            ...
            declaration ~= "    typeof(this." ~ field_name ~ ") " ~
                field_name ~ ",\n";
        }}
...
unittest {
    ...
    static assert(!__traits(compiles, () { Config value; }));
