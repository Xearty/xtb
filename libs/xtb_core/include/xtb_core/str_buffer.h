...
#define str_buffer_push_back_lit(str_buffer, lit) str_buffer_push_back((str_buffer), str(lit))
#define str_buffer_push_back_cstring(str_buffer, cstring) str_buffer_push_back((str_buffer), cstr(cstring))
...
#define str_buffer_push_front_lit(str_buffer, lit) str_buffer_push_front((str_buffer), str(lit))
#define str_buffer_push_front_cstring(str_buffer, cstring) str_buffer_push_front((str_buffer), cstr(cstring))

String str_buffer_view(StringBuffer *str_buffer);
#define str_buffer_view_copy(allocator, str_buffer) str_copy((allocator), str_buffer_view((str_buffer)))
